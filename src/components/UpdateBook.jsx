...
return(
   ...
   {/* create a modal for the update window */}
    ...
    <button type="button" className="btn btn-sm btn-info" data-toggle="modal" data-target={`#id${book.book_id}`}>Update
    </button>
  ...
  <div className="modal-dialog">
    ...
    {/* modal header */}
      <div className="modal-header">
        <h4 className="modal-title" style={{color:"#262626"}}>Edit Book</h4>
